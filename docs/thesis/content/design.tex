...
%- 12.5   X (imple) - mention semantic verionsing in monitoring (software used) + ansible like everything is pamametrized to be able to rollback
%13       X
%- 13.1   X
%14       X
%- 14.2   x
...
%TODO: maybe include a design of several environments only from the application POV e.g. scenario1 - FTP + mail + blog + gitlab, scenario2 - microservice application with multiple pods ...  should satisfy but maybe more
